...
import { allEmpresas, allEmpresaSelect, createCompanyBaja, createCompanyComplete, createCompanyCompleteMasive, generateExcel, getCategoryMateriality, getCategoryMaterialityClient, listTypeCompanies } from "../controllers/empresa.controller";
...
// router.get('/getCategoryMaterialityClient', getCategoryMaterialityClient);
